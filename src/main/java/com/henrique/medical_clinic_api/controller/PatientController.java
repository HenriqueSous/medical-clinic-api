...
public class PatientController {
    ...
    @PatchMapping("/{id}")
    private ResponseEntity<PatientResponseDTO> patch(@PathVariable long id, @RequestBody JsonNode jsonNode) {
        Patient patient = patientService.updateByParts(id, jsonNode);
